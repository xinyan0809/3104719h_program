...
export const FRUIT_FALL_SPEED = 105;
export const BASKET_SIZE = 112;
export const BASKET_HEIGHT = 66;
export const BASKET_OFFSET_Y = 30;
export const MAX_ACTIVE_FRUITS = 2;
export const WRIST_VISIBILITY_THRESHOLD = 0.55;
